  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="Hey! I'm Hrayr. I'm a Senior Full Stack Engineer (JS/TS/React/Node). I believe that people should do what they love. That's why I am here to enjoy my time by helping you and your business." />
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          Hey! I&apos;m Hrayr. I&apos;m a Senior Full Stack Engineer (JS/TS/React/Node...).
        </p>
        <p className={styles.description}>
